...
export const menuStructure: MenuStructure = {
  microfrontend: {
    message: "Configure Microfrontends",
    helpText: "Options for setting up and managing microfrontends.",
    options: [
      {
        name: "Set up a new host",
        value: "setupHost",
        helpText: "Initialize a new microfrontend host.",
        action: noop,
      },
      {
        name: "Set up a new remote",
        value: "setupRemote",
        helpText: "Initialize a new microfrontend remote.",
        action: noop,
      },
      {
        name: "List existing microfrontends",
        value: "listMicrofrontends",
        helpText: "Show all registered microfrontends.",
        action: noop,
      },
      {
        name: "Update configuration",
        value: "updateConfig",
        helpText: "Modify an existing microfrontend configuration.",
        action: noop,
      },
      {
        name: "Remove a microfrontend",
        value: "removeMicrofrontend",
        helpText: "Delete a microfrontend from the setup.",
        action: noop,
      },
    ],
  },
  eslint: {
    ...
    options: [
      {
        name: "Set up ESLint with recommended rules",
        value: "setupESLint",
        helpText: "Configure ESLint for the project.",
        action: noop,
      },
      {
        name: "Configure Prettier",
        value: "setupPrettier",
        helpText: "Set up Prettier for code formatting.",
        action: noop,
      },
      {
        name: "Apply stylelint for CSS/Sass",
        value: "setupStylelint",
        helpText: "Enable stylelint for better CSS/Sass quality.",
        action: noop,
      },
      {
        name: "Add TypeScript configuration",
        value: "setupTSConfig",
        helpText: "Configure TypeScript settings.",
        action: noop,
      },
    ],
  },
  inject: {
    ...
    options: [
      {
        name: "Inject WebComponent wrapper",
        value: "injectWebComponent",
        helpText: "Wrap code in a WebComponent.",
        action: noop,
      },
      {
        name: "Add import maps for module federation",
        value: "injectImportMaps",
        helpText: "Configure import maps for remote modules.",
        action: noop,
      },
      {
        name: "Configure Vite plugin federation",
        value: "injectViteFederation",
        helpText: "Set up Vite federation plugin.",
        action: noop,
      },
      {
        name: "Generate custom entry point",
        value: "generateEntryPoint",
        helpText: "Create an entry file for the microfrontend.",
        action: noop,
      },
    ],
  },
  validate: {
    ...
    options: [
      {
        name: "Validate microfrontend setup",
        value: "validateMicrofrontend",
        helpText: "Check if the microfrontend configuration is correct.",
        action: noop,
      },
      {
        name: "Check ESLint configuration",
        value: "validateESLint",
        helpText: "Verify ESLint settings.",
        action: noop,
      },
      {
        name: "Check TypeScript configuration",
        value: "validateTSConfig",
        helpText: "Ensure TypeScript is correctly configured.",
        action: noop,
      },
      {
        name: "Check for dependency issues",
        value: "validateDependencies",
        helpText: "Detect missing or outdated dependencies.",
        action: noop,
      },
    ],
  },
...
export const mainMenu = {
  ...
  options: [
    ...
    })),
    {
      name: "Help",
      value: "help",
      helpText: "List available commands and their descriptions.",
    },
